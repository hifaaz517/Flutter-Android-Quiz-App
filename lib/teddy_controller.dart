...
import 'QuizIdScreen.dart';
import 'QuizProfileScreen.dart';
...
class TeddyController extends FlareControls {
  ...
  //setting global email and pasword variable
  ...
  newSubmitPasswordFaculty(
    ...
    try {
      ...
      switch (e.code) {
        ...
        case 'ERROR_USER_NOT_FOUND':
          ...
          break;
        default:
          print('An unkmown error occured');
          play('fail');
      }
      // xxx = false;
    }
    ...
    if (xxx == true) {
      ...
      Provider.of<Profile>(context, listen: false)
          .getFirebaseUserIDFaculty(users);
  ...
  void newSubmitPasswordStudent(
    ...
    // Provider.of<Model>(context, listen: false)
    //     .getFirebaseQuestionStudent('Null');
    // Provider.of<Model>(context, listen: false)
    //     .getFirebaseQuestionStudentFlagValue();
    ...
    if (xxx == true) {
      ...
      Provider.of<Profile>(context, listen: false)
          .getFirebaseUserIDStudent(users);
      Provider.of<Model>(context, listen: false)
          .getFirebaseUserIDStudent(users);
