...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FacultyMyHomePage(title: 'Flutter Demo Home Page'),
    );
  }
}

class FacultyMyHomePage extends StatefulWidget {
  FacultyMyHomePage({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<FacultyMyHomePage> {
                              ...
                              SigninButton(
                                ...
                                onPressed: () {
                                  ...
                                  Future.delayed(Duration(milliseconds: 0))
                                    ...
                                    _teddyController.newSubmitPasswordFaculty(
